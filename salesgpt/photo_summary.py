...
class PhotoSummarizer(LLMChain):
    ...
    def from_llm(cls, llm , verbose: bool = True) -> LLMChain:
        ...
        photo_summarizer_prompt_template = """You are a renowned journalist with Harvard education and more than 30 years of experience helping to form emotional and spicy relationship with a person.
